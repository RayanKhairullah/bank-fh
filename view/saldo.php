...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!empty($_POST['nomor_rekening'])) {
        ...
        $sql = "SELECT nama_nasabah, saldo FROM nasabah WHERE nomor_rekening = '$nomrek'";
...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 20px; text-align: center;">
        ...
        <p style="margin-bottom: 15px;">Nama Nasabah: <strong><?= htmlspecialchars($nama_nasabah) ?></strong></p>
